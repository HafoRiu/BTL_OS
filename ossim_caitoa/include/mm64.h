...
// Override the 32-bit definitions with 64-bit specific ones
#undef PAGING_PAGESZ
#define PAGING_PAGESZ PAGING64_PAGESZ

#undef PAGING_PAGE_ALIGNSZ
#define PAGING_PAGE_ALIGNSZ(sz) PAGING64_PAGE_ALIGNSZ(sz)

#undef PAGING_MAX_PGN
#define PAGING_MAX_PGN PAGING64_MAX_PGN

#undef PAGING_OFFST
#define PAGING_OFFST(x) GETVAL(x, PAGING64_ADDR_OFFST_MASK, PAGING64_ADDR_OFFST_LOBIT)

#undef PAGING_PGN
#define PAGING_PGN(x) ((x) >> PAGING64_ADDR_PT_SHIFT)
